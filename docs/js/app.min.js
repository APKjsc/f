...
var app = (function App() {
	...
	function init() {
		...
		page('/f/:blog', showWork);
		page.exit('/f/:blog', hideWork);
		page('/', showTimeline);
		...
		page('/about-us', showAbout);
		page.exit('/about-us', hideAbout);
		page.start();
...
function AboutView(options) {
	...
	function animate() {
		...
		var p3 = new SplitText('.about-view .content .p3', { type: 'words' });
    ...
    tl.staggerFrom(p3.words, 1, { opacity: 0 }, 0.03, '-=0.7');
...
function SearchView() {
	...
	function init() {
		...
		$('.search__results').on('click', '.search-results > li', function (e) {
			...
			page('/f/' + e.currentTarget.getAttribute('data-url'), data);
		});
