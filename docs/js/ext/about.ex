	...
	<div ng-class="{'scroll': page=='about'}" class="aboutOuter">
		<div class="about">
			<div abouts="abouts" ng-class="{'hide': page!='about'}" class="aboutInner">
				...
				<div class="social"><a href="mailto:…@703705.XYZ" target="blank"><i class="i-mail"><h2>email </h2></i></a><a href="https://facebook.com/AQViet" target="blank"><i class="i-facebook"><h2>facebook </h2></i></a><a href="https://twitter.com/AQViet" target="blank"><i class="i-twitter"><h2>twitter </h2></i></a>
				</div>
			</div>
		</div>
	</div>
